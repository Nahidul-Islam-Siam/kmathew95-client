...
const SubAdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    ...
    {
      key: "/sub-admin/wallet",
      icon: <Wallet size={20} />,
      label: "Wallet",
    },
    {
      key: "/sub-admin/subscription",
      icon: <CreditCard size={20} />,
      label: "Subscription",
    },
    {
      key: "/sub-admin/referral",
      icon: <BookmarkCheck size={20} />, // Reverted to BookmarkCheck
      label: "Referral",
    },
    {
      key: "/sub-admin/reviews",
      icon: <Star size={20} />,
      label: "Reviews",
    },
    {
      key: "/sub-admin/add-category",
      icon: <MdAddCircleOutline size={20} />,
      label: "Add Category",
    },
    {
      key: "/sub-admin/profile",
